...
\catalogtype{Trabalho de Conclusão de Curso (Graduação)} % e.g. ``Tese (doutorado)''
\catalogtopics{LLM; Engenharia de Requisitos; Verificação Automatizada; Engenharia de Prompt}
\catalogcdd{NUMERO CDD}
\catalogingsheet
...
\include{src/introducao.tex}
\include{src/engenharia_software.tex}
\include{src/aprendizado_maquina.tex}
\include{src/desenvolvimento.tex}   
